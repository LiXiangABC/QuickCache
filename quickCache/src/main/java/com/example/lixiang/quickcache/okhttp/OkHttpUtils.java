package com.example.lixiang.quickcache.okhttp;
...
import com.example.lixiang.quickcache.okhttp.builder.GetBuilder;
import com.example.lixiang.quickcache.okhttp.builder.PostFileBuilder;
import com.example.lixiang.quickcache.okhttp.builder.PostFormBuilder;
import com.example.lixiang.quickcache.okhttp.builder.PostStringBuilder;
import com.example.lixiang.quickcache.okhttp.callback.Callback;
import com.example.lixiang.quickcache.okhttp.cookie.SimpleCookieJar;
import com.example.lixiang.quickcache.okhttp.https.HttpsUtils;
import com.example.lixiang.quickcache.okhttp.request.RequestCall;
import com.example.lixiang.quickcache.utils.ToastUtil;
        ...
        mDelivery.post(new Runnable()
        {
            ...
            public void run()
            {
                if (e.toString().contains("No address associated with hostname")) {
                    ToastUtil.showToast(context, "当前无网络，请重新连接");
                }
//                else {
